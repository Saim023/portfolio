...
import screen1 from '../../assets/images/project-1.png';
import screen2 from '../../assets/images/p1-s2.png';
import screen3 from '../../assets/images/p1-s3.png';
    ...
    return (
        <div>
            ...
            <div className='min-h-screen bg-[#22252c] pt-20 pb-20'>
                <h1 className="text-color text-5xl text-center font-bold pb-16">PROJECT ONE</h1>
                ...
                <div className="hero ">
                    <div className="hero-content flex-col lg:flex-row">
                        ...
                        <div className='text-white pl-5'>
                            <h1 className="about-color">Phone Planet</h1>
                            <ul className=''>
